...
echo "Your HIBERA Masternode Will be Updated To The Latest Version v1.1.0 Now" 
...
cd ~/.hibera/
wget https://github.com/Hiberabib/bib/releases/download/v1.1.0/bootstrap.zip
unzip bootstrap.zip

cd ..
rm -rf ~/.hibera/bootstrap.zip ~/BIB_1.1.0
